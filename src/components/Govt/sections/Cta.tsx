...
export const Cta = () => {
  ...
  const handleStartChat = () => {
    ...
    setTimeout(() => {
      ...
      const message = `Hello, my name is ${userName}. I am interested in your ${selectedService} service. You can reach me at ${userEmail}.`;
    ...
    <>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex justify-center items-center px-4">
          ...
          />
          <div className="relative bg-white rounded-2xl px-6 py-8 max-w-md w-full shadow-2xl animate-slide-up">
            {isLoading ? (
                ...
                <div className="space-y-4">
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none transition-all duration-200 bg-gray-50/50"
                      required
                    />
                  </div>

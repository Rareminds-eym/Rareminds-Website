  ...
  return (
    <section className="relative bg-white overflow-hidden py-16 px-6 lg:px-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between">
        ...
        >
          <h2 className="text-4xl font-bold text-gray-900">Custom FDP Solutions for Your Institution</h2>
          ...
          <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-blue-800/30 border border-blue-400/30 px-4 py-3 rounded-full font-semibold flex items-center gap-2" 

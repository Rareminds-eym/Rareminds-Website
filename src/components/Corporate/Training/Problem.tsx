...
const circleImages: CircleImage[] = [
  {
    ...
    alt: "A frustrated person holding their head in front of a computer with gears and a no-signal icon, illustrating system failure or productivity block.",
    color: "bg-[#eeffcc]",
    delay: 0.2,
  },
  {
    image: "Burned-out.webp",
    alt: "A stressed man sitting at a desk in front of a computer, showing an error screen, depicting a workplace technical issue or frustration.",
    color: "bg-[#ffffff]",
    delay: 0.3,
  },
  {
    image: "Hired-fresh.webp",
    alt: "Animated character joyfully throwing items in the air, symbolizing celebration, success, or the end of work stress.",
    color: "bg-[#fbd1e9]",
    delay: 0.4,
  },
  {
    image: "Learning-limited.webp",
    alt: "Illustration of a confused person surrounded by question marks and symbols, representing uncertainty or difficulty in understanding.",
    color: "bg-[#ffa6b3]",
    delay: 0.5,
  },
  {
    image: "Promoted.webp",
    alt: "Abstract illustration of a blank or partially open document, symbolizing incomplete work or a draft.",
    color: "bg-[#fce8b6]",
    delay: 0.6,
  },
  {
    image: "Remote.webp",
    alt: "Relaxed person leaning back at a desk with a plant and laptop, representing calm, satisfaction, or work-life balance.",
    color: "bg-[#dfe7fe]",
    delay: 0.7,
  },
  {
    image: "Teamwork.webp",
    alt: "Teamwork concept with three people inside gear wheels collaborating, symbolizing innovation and idea generation.",
    color: "bg-[#c5c2ff]",
    delay: 0.8,
  },
];

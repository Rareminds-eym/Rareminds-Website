...
const features = [
	{
		...
		description:
			"Leadership, Tech, Sales, Compliance, DEI & more—built for impact, not just info.",
	...
	},
	{
		...
		description:
			"Scenarios, roleplays, and gamified tasks because growth doesn't come from slides.",
	...
	},
	{
		...
		description:
			"We bring the coach, the content, and the tracking. You bring the team.",
	...
	},
	{
		...
		description:
			"From factory floor to boardroom—everyone levels up in their preferred language.",
					...
					{features.map((feature, index) => (
						...
						>
							...
							<div className="relative bg-white/40 backdrop-blur-sm p-4 sm:p-6 rounded-xl sm:rounded-2xl transform hover:translate-y-[-0.5rem] sm:hover:translate-y-[-1rem] transition-all duration-300 border border-white/20">
								<Icon
									icon={feature.icon}
									className="w-6 h-6 sm:w-7 sm:h-7 text-gray-700 mb-4 sm:mb-6 transform group-hover:scale-110 transition-transform duration-300"
								/>

      ...
      <div className="h-full w-full overflow-auto">
        ...
        >
          <AnimatePresence mode="wait" initial={false}>
            ...
            >
              <div className="container flex flex-col lg:flex-row justify-between w-full px-4 md:px-8 lg:px-14">
                {/* Left side - Text content */}
                <div className="w-full lg:w-[60%] py-6 lg:py-0 lg:pr-8 mb-4 lg:mb-0 text-center lg:text-left lg:-mt-14">
                  <div className="relative min-h-[90px]">
                    <div className="mb-10">
                      <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-[40px] font-bold !leading-[1.5] md:!leading-[1.4]">
                    ...
                    <AnimatePresence mode="wait" initial={false}>
                      <motion.p
                        ...
                        className="text-sm sm:text-base lg:text-lg max-w-2xl lg:max-w-none mx-auto lg:mx-0 w-full mt-2"
                        initial={{
                          opacity: 0,
                          x: 40,
                          scale: 0.95,
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 mt-6 justify-center lg:justify-start">
                    <button
                      className="corporate-btn-1 bg-black hover:bg-black/80"

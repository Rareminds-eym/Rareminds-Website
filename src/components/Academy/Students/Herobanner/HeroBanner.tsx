...
const HeroBanner = ({  HeroToContact,HeroToLogo, isBlurred }: HeaderProps) =>{
  ...
  return (
    <section className={`w-full h-screen relative overflow-hidden ${isBlurred ? 'blur-[8px] brightness-90' : ''}`}>
        ...
        <div className="w-full mx-auto px-4 py-8">
          ...
          <div className="relative w-full mb-8">
            <div className="flex flex-col md:flex-row w-full h-screen overflow-hidden bg-white/90">
              {/* Left: Carousel (1/3) */}
              <div className="w-full md:w-2/5  md:h-full flex-shrink-0 flex items-center justify-center">

...
//             <div className="max-w-lg ml-10 mt-12">
//               <h1 className="text-5xl font-semibold mb-10 text-gray-900 text-center">Success Stories</h1>
//               <p className="text-xl mb-10 ml-5 font-normal text-gray-700 leading-relaxed">
...
//                     className="w-full px-4 py-3 pr-12 rounded-lg bg-white border border-gray-200 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm"
//                   />
//                   <svg 
...
//             <div className="max-w-lg lg:ml-10 lg:mt-12 w-full lg:w-auto flex flex-col items-center lg:items-start">

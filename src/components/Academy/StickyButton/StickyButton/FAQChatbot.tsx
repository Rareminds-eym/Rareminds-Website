...
import faqData from "../../../Academy/UI/faqData";
      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className="fixed bottom-40 right-6 w-[350px] max-w-[calc(100vw-32px)] max-h-[80vh] bg-white shadow-2xl rounded-2xl z-50 overflow-hidden flex flex-col"
          >

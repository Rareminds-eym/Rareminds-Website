...
const FooterBar = () => {
  ...
  const isCorporate = window.location.pathname.startsWith(
    "/corporate/recruitment"
  );
  const isCorporateTraining = window.location.pathname.startsWith(
    "/corporate/training"
  );
  ...
  return (
    ...
    >
      ...
      <div className="relative lg:px-14 grid lg:grid-cols-5 grid-cols-1 gap-4 container mx-auto py-12">
        {/* Links Section */}
        <div>

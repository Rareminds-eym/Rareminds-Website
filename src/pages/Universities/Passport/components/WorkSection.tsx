        ...
        <div className="hidden md:flex justify-center md:-mt-0 lg:-mt-20">
          <div className="relative mx-auto md:w-[450px] lg:w-[550px] xl:w-[650px]">
            ...
            >
              ...
              <path d="M725.742 26.6373C732.227 26.6373 737.483 21.3459 737.483 14.8186C737.483 8.29139 732.227 3 725.742 3C719.257 3 714 8.29139 714 14.8186C714 21.3459 719.257 26.6373 725.742 26.6373Z" fill="white" stroke="black" strokeWidth="2.89" strokeMiterlimit="10" strokeDasharray="6.93 6.93" />
            </svg>
        ...
        <div className="hidden md:flex justify-center md:-mt-4 lg:-mt-24 xl:-mt-28">
          <div className="relative mx-auto md:w-[450px] lg:w-[550px] xl:w-[650px]">
            ...
            <svg
              ...
              className="absolute top-0 left-0 w-full h-full"
            >
              <path d="M13.7417 26.6373C20.2265 26.6373 25.4835 21.3459 25.4835 14.8186C25.4835 8.29139 20.2265 3 13.7417 3C7.25696 3 2 8.29139 2 14.8186C2 21.3459 7.25696 26.6373 13.7417 26.6373Z" fill="white" stroke="black" strokeWidth="2.89" strokeMiterlimit="10" strokeDasharray="6.93 6.93" />
              <path d="M25 10.2507C50.3504 -1.0443 88.0268 -5.3909 127.771 45.3601C193.142 128.833 205.744 304.778 266.905 362.936C316.631 410.198 362.58 385.22 392.986 357.886C500.804 91.7033 627.611 79.8267 693.68 279.647C700.519 300.339 708.047 325.929 715.29 358.957C723.323 395.627 728.562 430.247 732 457" stroke="black" strokeWidth="5" strokeMiterlimit="10" strokeDasharray="12 12" />

    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-12 sm:py-16 md:py-24">
        <header className="max-w-3xl mx-auto text-center mb-12 sm:mb-16">
          ...
          >
            A Success Story in{" "}
            <span className="text-[#000000]">Educational Innovation</span>
          </h1>
        ...
        >
          <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 md:p-12 border border-gray-200 transition-all duration-300 hover:shadow-2xl hover:scale-[1.01] text-center">
            <h2
              id="case-study-title"
              className="text-lg sm:text-xl md:text-2xl font-bold text-black mb-4"
            >
              Case Study:{" "}
              <span>Naan Mudhalvan Program</span>
            </h2>
            ...
            <p className="text-sm sm:text-base md:text-lg text-gray-800 leading-relaxed mb-4">
              ...
              <span className="font-semibold">Rareminds</span> to
            ...
            <p className="text-sm sm:text-base md:text-lg text-gray-800 leading-relaxed">
              ...
              the results exceeded expectations, transforming how the institution
              approaches student skill development and career readiness.
            </p>
          </div>
        </section>
        ...
        <section className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            {/* Stat 1 */}
            <article
              className="bg-white rounded-2xl shadow-md p-6 sm:p-8 border border-gray-200 transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
            ...
            >
              <div className="flex flex-col items-center">
                <div className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-red-50 mb-4">
                  <TrendingUp className="w-6 h-6 text-[#E32A18]" />
                </div>

                <div className="text-4xl sm:text-5xl font-extrabold text-[#000000] mb-3 leading-tight">
                  86%
                </div>

                <p className="text-sm sm:text-base text-black-700 text-center font-medium leading-relaxed">
            ...
            >
              <div className="flex flex-col items-center">
                <div className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-red-50 mb-4">
                  <Users className="w-6 h-6 text-[#E32A18]" />
                </div>

                <div className="text-3xl sm:text-4xl font-extrabold text-[#000000] mb-3 leading-tight">
                  Clear
                </div>

                <p className="text-sm sm:text-base text-black-700 text-center font-medium leading-relaxed">
                  Visibility for departments to identify and address skill gaps
                  effectively
                </p>
              </div>
            </article>
            ...
            >
              <div className="flex flex-col items-center">
                <div className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-red-50 mb-4">
                  <Zap className="w-6 h-6 text-[#E32A18]" />
                </div>

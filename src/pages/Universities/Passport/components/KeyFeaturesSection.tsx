  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        >
          Explore the essential capabilities of the Skill Passport platform that empower institutions and students alike.</p>
        ...
        <div className="max-w-6xl mx-auto mt-16 px-6 text-center">
          <p className="text-base text-gray-800 italic">
            <p className="mt-8 text-center text-[#000000] text-sm md:text-base italic font-medium max-w-6xl mx-auto">
<span className="text-[#E32A18]">Result:</span> Institutions gain data-backed insights, enhance accreditation outcomes, and strengthen student placement success.      </p>
          </p>
        </div>
      </div>
    </section>

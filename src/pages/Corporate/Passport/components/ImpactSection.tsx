  ...
  return (
    <section className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        {/* ✅ Mobile Auto-Slider */}
        <div className="relative block md:hidden overflow-hidden pb-4 -mx-4 px-0">
        ...
        {/* ✅ Desktop Grid */}
        <div className="hidden md:grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-10 items-center">

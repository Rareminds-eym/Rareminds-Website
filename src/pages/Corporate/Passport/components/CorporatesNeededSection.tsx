    ...
    <section className="py-16 md:py-20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <p className="mt-8 text-center text-[#000000] text-sm md:text-base italic font-medium max-w-6xl mx-auto">
          <span className="text-[#E32A18] font-bold">Result:</span> From Training to Transformation. The Skill Passport transforms training data into business intelligence — helping organizations make better people decisions, faster.
        </p>

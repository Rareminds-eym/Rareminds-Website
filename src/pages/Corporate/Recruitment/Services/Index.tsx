      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-blue-800 via-indigo-900 to-blue-950 text-white">
          ...
          <div className="absolute inset-0 opacity-10">
            <svg className="w-full h-full" viewBox="0 0 1200 800" fill="none">
              <defs>
                ...
                >
                  <path
                    d="M30 4l26 15v26L30 60 4 45V19z"
          ...
          <div className="absolute inset-0 opacity-20">
            <svg className="w-full h-full" viewBox="0 0 1200 800" fill="none">
              <path
                d="M100 100h200v100h300v-50h200"
                stroke="url(#lineGrad1)"
                strokeWidth="2"
              />
              <path
                d="M50 300h150v-100h250v150h200"
                stroke="url(#lineGrad2)"
                strokeWidth="2"
              />
              <path
                d="M200 500h300v-200h200v100h150"
          ...
          <div className="absolute inset-0 opacity-5">
            ...
            `,
                backgroundSize:
                  "80px 80px, 120px 120px, 100px 100px, 140px 140px",
              }}
            ></div>
          </div>
          ...
          <div className="relative mx-auto max-w-5xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div className="flex-1 space-y-6">
              ...
              <p className="text-lg text-blue-100/90 max-w-xl">
                Modern, scalable recruitment solutions to help you attract,
                hire, and retain top talent in today's competitive market.
              </p>
                ...
                <Link to="/corporate/recruitment/contact">
                  <button className="group relative corporate-btn-2 bg-white text-black overflow-hidden flex items-center gap-2">
                    ...
                    <Icon
                      ...
                      className="w-5 h-5 text-black group-hover:translate-x-1 transition-transform duration-200 z-10"
                    />
          ...
          <div className="mt-20">
            ...
            >
              ...
              <div className="absolute inset-0 opacity-15">
                ...
                >
                  <path
                    d="M50 50h80v30h120v-15h100"
                    stroke="rgba(255, 255, 255, 0.4)"
                    strokeWidth="1"
                  />
                  <path
                    d="M30 120h60v-40h100v60h80"

...
// Image structure for text content sections
...
export interface TextContent {
  text: string;
  images?: ImageItem[];  // Optional array of images (for introduction sections)
  image?: ImageItem;     // Optional single image (for conclusion sections)
}
...
// Omits conflicting snake_case fields from Program that are replaced by camelCase
// equivalents below, eliminating duplicate fields for the same data and ensuring
// TypeScript consumers always use the correct authoritative field.
export interface ProgramWithTransformedSections extends Omit<Program, 'banner_url' | 'image_url' | 'program_type'> {
